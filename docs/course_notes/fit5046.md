...
1. Lateral navigation  横向导航 Lateral Navigation occurs between screens  at the same level of hierarch; Using Navigation Drawer, Tabs, or Navigation Bar ![](../img/fit5046-20230327.png)  
2. Forward navigation  前向导航 Downward from a parent screen to a child  
...
3. Reverse navigation  反向导航 Reverse navigation refers to backward movement between screens. It can move users chronologically through their recent screen history, or upwards through an app's hierarchy. ![](../img/fit5046-20230327-2.png)
### Navigation Drawer
